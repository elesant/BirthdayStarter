...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Present.birthday'
        db.add_column('table_present', 'birthday',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Birthday'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Present.birthday'
        db.delete_column('table_present', 'birthday_id')
    ...
    models = {
        ...
        u'core.present': {
            ...
            'asn': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'birthday': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Birthday']", 'null': 'True', 'blank': 'True'}),
