...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Present.cost'
        db.alter_column('table_present', 'cost', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Present.cost'
        db.alter_column('table_present', 'cost', self.gf('django.db.models.fields.PositiveIntegerField')())
