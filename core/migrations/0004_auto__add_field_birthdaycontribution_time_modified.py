...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BirthdayContribution.time_modified'
        db.add_column('table_birthday_contribution', 'time_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 5, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BirthdayContribution.time_modified'
        db.delete_column('table_birthday_contribution', 'time_modified')
